        ...
        <div className="col-start-2 col-end-3 flex flex-col">
          <div className="m-10 flex flex-col">
            ...
            <div className="flex flex-col pt-10">
              <a href="https://github.com/ryanwarsaw" className="p-2 text-sm text-indigo-400 border-b">GitHub Portfolio</a>
              <a href="https://www.linkedin.com/in/ryanwarsaw/" className="p-2 text-sm text-indigo-400 border-b">LinkedIn Profile</a>
              <a href="mailto:me@ryanwarsaw.com" className="p-2 border-b text-sm text-indigo-400">Contact Me</a>
            </div>
          </div>
        </div>
